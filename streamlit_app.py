...
"""
    ...
    base_prompt += """\n**답변 시 중요 지침:**
1. 위 규정 문서의 내용을 참고하여 답변할 때는 반드시 구체적인 조항 번호(예: 제○조, 제○조 제○항 등)를 명시하세요.
2. 추상적이거나 일반적인 답변을 피하고, 규정에 명시된 구체적인 내용을 인용하세요.
3. 만약 규정에 명확한 기준이나 기간이 명시되어 있지 않다면, 그 사실을 정확히 알려주세요.
4. 사용자의 질문에 따라 필요한 서류를 명확하고 친절하게 안내하세요. 단계별로 설명하고, 추가 궁금한 사항을 묻습니다."""
